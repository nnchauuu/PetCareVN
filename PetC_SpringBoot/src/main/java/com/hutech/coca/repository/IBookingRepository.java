...
public interface IBookingRepository extends JpaRepository<Booking, Long> {
    ...
    long countByBookingStatusAndCreateAtGreaterThanEqualAndCreateAtLessThanAndIsDeletedFalse(
    ...
    @Query("SELECT b FROM Booking b " +
            ...
            "AND b.createAt >= :from AND b.createAt < :to " +
            "AND b.isDeleted = false " +
            "ORDER BY b.createAt DESC")
    List<Booking> findCancelledBookingsInPeriod(
